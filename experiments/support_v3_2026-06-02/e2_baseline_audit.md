...
| h_edit_r_p2p | diffusion_bridge_p2p | medium_non_rf | ok | text-guided/main_demo.py | needs_env | 0 | 0 | 0 | baseline_audit | - | do_not_claim_beat |
| instruct_pix2pix | diffusion_instruction_editing | medium_non_rf | ok | edit_cli.py;main.py | needs_env | 0 | 0 | 0 | baseline_audit | - | do_not_claim_beat |
