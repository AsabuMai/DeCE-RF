...
#SBATCH -J e2-flux-11-12
#SBATCH -o /cluster/users/grad/2025/25t8103/project/_baselines/logs/e2_native_flux_gate/e2_native_flux_seed11_12_%j.out
#SBATCH -e /cluster/users/grad/2025/25t8103/project/_baselines/logs/e2_native_flux_gate/e2_native_flux_seed11_12_%j.err
...
LOG_DIR="$BASE/logs/e2_native_flux_gate/e2_native_flux_seed11_12_${SLURM_JOB_ID:-manual}"
...
if [[ "$host" != "a100-01.gpu01.cis.k.hosei.ac.jp" ]]; then
  echo "Refusing to run E2 native FLUX expansion outside a100-01" >&2
  exit 2
fi

cp "$MANIFEST" "$MANIFEST.before_e2_native_flux_seed11_12_${SLURM_JOB_ID:-manual}.bak"
touch "$SUMMARY"
...
run_step rf_solver_edit_seed11_12 \
...
for baseline in ["fireflow", "rf_solver_edit", "reflex"]:
    subset = [r for r in rows if r["baseline"] == baseline and r["seed"] in {"10", "11", "12"}]
